...
export const skillCategories: SkillCategory[] = [
  ...
  { title: "AI / ML", items: ["OpenAI API", "LLM Integration", "Prompt Engineering", "Automated Reporting"] },
  { title: "Databases", items: ["PostgreSQL", "MySQL", "Firestore (NoSQL)", "SQLite"] },
  { title: "Cloud & DevOps", items: ["GCP (Cloud Run)", "Firebase", "AWS", "Vercel", "Docker", "GitHub Actions", "CI/CD"] },
