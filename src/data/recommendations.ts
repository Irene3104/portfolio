...
export const recommendations: Recommendation[] = [
  {
    quote:
      "What stands out about Seoyoon isn't just her engineering. It's the breadth of experience she brings from outside of IT. When we started building SAIXAN, she had no background in accounting or how Japanese P&L structures work, but she picked it up faster than I expected and translated our messy internal logic into a system that actually fits how we run the business. She delivered the whole platform on her own, from architecture to deployment. She's already a strong developer, but what I value most is her potential to keep growing, and how well she understands the business side, not just the code. That's rare, and it makes her easy to work with at the management level too.",
