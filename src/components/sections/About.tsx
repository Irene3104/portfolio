...
const aboutCards: AboutCardData[] = [
  {
    ...
    iconBg: "bg-[rgba(176,184,66,0.12)]",
...
function TiltCard({
  ...
  return (
    <ScrollReveal delay={delay} className="h-full">
      <div
        ref={cardRef}
        className="h-full rounded-[20px] border border-accent-1/8 bg-bg-card p-7 transition-all duration-300 hover:border-accent-1/20 hover:shadow-[0_8px_40px_rgba(176,184,66,0.08)] max-md:p-[22px]"
      >
        {children}
      </div>
    </ScrollReveal>
