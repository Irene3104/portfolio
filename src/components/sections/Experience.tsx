...
function TimelineCard({
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="rounded-2xl border border-accent-1/8 bg-bg-card p-6 transition-all duration-300 hover:border-accent-1/20 hover:shadow-[0_4px_24px_rgba(192,132,252,0.06)] max-md:p-5">
