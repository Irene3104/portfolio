    ...
    >
      ...
      <span
        className={`absolute -left-8 top-6 z-10 h-4 w-4 rounded-full border-[3px] border-accent-1 max-md:-left-6 max-md:h-3.5 max-md:w-3.5 ${
          index === 0
            ? "bg-accent-1 shadow-[0_0_12px_rgba(34,211,238,0.4)]"
            : "bg-bg-primary"
        }`}
      />

      {/* Card */}
      <div className="rounded-2xl border border-accent-1/8 bg-bg-card p-6 transition-all duration-300 hover:border-accent-1/20 hover:shadow-[0_4px_24px_rgba(34,211,238,0.06)] max-md:p-5">
